...
namespace WebSGC.Models.DAL
{
    public class BancoDAL
    {
        ...
        protected BancoDAL()
        {
            //_strConexao = @"Data Source=localhost;Initial Catalog=idealweb;Persist Security Info=True;User ID=root;Password=paga23568193;Convert Zero Datetime=true;";
            //_strConexao = @"Data Source=mysql13-farm76.kinghost.net;Initial Catalog=idealinfo01;Persist Security Info=True;User ID=idealinfo01;Password=ideal1357;Convert Zero Datetime=true;";
            //_strConexao = @"Data Source=localhost;Initial Catalog=idealinfo2021;Persist Security Info=True;User ID=root;Password=135790;Convert Zero Datetime=true;";
            _strConexao = @"Data Source=localhost;Initial Catalog=wk;Persist Security Info=True;User ID=root;Password=135790;Convert Zero Datetime=true;";
        ...
        protected BancoDAL(string stringConexao)
        {
